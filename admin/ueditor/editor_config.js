...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["fullscreen","source","fontsize","bold","italic","underline","strikethrough","forecolor","undo","redo","insertunorderedlist","insertorderedlist","justifyleft","justifycenter","justifyjustify","justifyright","unlink","link","horizontal","emotion","insertimage","insertvideo","insertframe","map","blockquote","backcolor","indent","removeformat","formatmatch","autotypeset","fontfamily","inserttable","deletetable","searchreplace","selectall","cleardoc","preview","help"],[]]
